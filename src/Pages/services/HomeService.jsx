...
const HomeServices = () => {
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 py-10">
      {/* Heading */}
      <div className="mb-6">
        <h1 className="text-4xl font-bold text-blue-900 mb-2">Home Appliences Services</h1>
        <p className="text-gray-600 text-lg">Professional Home Applier repairs, installations, and maintenance for your home</p>
      </div>

      {/* Main Grid */}
      <div className="grid md:grid-cols-2 gap-10 items-start">
        {/* Image */}
        <img src={HomeImg} alt="Home" className="rounded-xl w-full" />
...
{/* Why Choose Us */}
<div className="mt-16">
  <h3 className="text-2xl font-bold text-gray-800 mb-6">💡 Why Choose Our Home Services?</h3>
  <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6">
    {[
      { icon: "🛡️", text: "HVAC Certified Technicians" },
      { icon: "⏱️", text: "Emergency HVAC Service" },
      { icon: "👍", text: "Quality Workmanship" },
      { icon: "👷", text: "Manufacturer Trained" },
    ].map((item, i) => (
      <div
        key={i}
